NOTE:   I, Powell "Alex" Mims, added the function set_icon() to CImg.h on 3/9/2023
        for the purpose of inserting K-Imager's icon on the CImgDisplay windows.
        
        // I am adding some stuff here ~Alex Mims
        CImgDisplay& set_icon(const HICON hIcon) {
            //if (is_empty()) return *this;
            SendMessageA(_window, WM_SETICON, (WPARAM)ICON_SMALL, (LPARAM)hIcon);
            return *this;
        }
        //

        If you would like to use the CImg library in your own project, I recommend using
        the official version (found at http://cimg.eu).

        I take no responsibility for any damages resulting from use of this copy of CImg.h,
	  and my changes to this file will continue to fall under the terms of the dual-license
        described in the file:  CeCILL-C or CeCILL v2.1

	  As this is a redistribution for the purpose of building my project, most of the files
        described below in this document are not included here.  Please locate the official
        version (found at http://cimg.eu).
